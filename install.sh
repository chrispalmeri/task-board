...
build=/home/www-data/task-board
serve=/srv/task-board
...
if [[ -d /home/www-data/task-board ]]; then
  cd /home/www-data/task-board
  ...
  sudo -u www-data git clone https://github.com/chrispalmeri/task-board.git /home/www-data/task-board
fi
